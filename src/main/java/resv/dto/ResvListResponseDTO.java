...
public record ResvListResponseDTO(
        @JsonProperty("resv_list") List<ResvListItemDTO> resvList,
        @JsonProperty("page_num") int pageNum,
        @JsonProperty("page_size") int pageSize,
        @JsonProperty("total_elements") long totalElements,
        @JsonProperty("total_pages") int totalPages
) {
    public static ResvListResponseDTO of(Page<ResvListItemDTO> page) {
        return new ResvListResponseDTO(page.getContent(), page.getNumber(), page.getSize(), page.getTotalElements(), page.getTotalPages());
    }

    public record ResvListItemDTO(
